...
SpreadsheetName = 'Chinese Food Items'
...
metaData = lookForFile(drive_service, SpreadsheetName)

print 'Downloading the spreadsheet'
resp, content = drive_service._http.request(metaData['exportLinks']['application/x-vnd.oasis.opendocument.spreadsheet'])
f = open('temp.xlsx', 'w')
f.write(content)
f.close()
